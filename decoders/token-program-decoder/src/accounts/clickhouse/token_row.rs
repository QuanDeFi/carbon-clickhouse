    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                name: "mint".to_string(),
                clickhouse_type: r#"String"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS mint String"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN mint String"),
            },
            ClickHouseColumnDefinition {
                name: "token_owner".to_string(),
                clickhouse_type: r#"String"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS token_owner String"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN token_owner String"),
            },
            ClickHouseColumnDefinition {
                name: "amount".to_string(),
                clickhouse_type: r#"UInt64"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS amount UInt64"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN amount UInt64"),
            },
            ClickHouseColumnDefinition {
                name: "delegate".to_string(),
                clickhouse_type: r#"Nullable(String)"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS delegate Nullable(String)"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN delegate Nullable(String)"),
            },
            ClickHouseColumnDefinition {
                name: "state".to_string(),
                clickhouse_type: r#"Enum8('Uninitialized' = 0, 'Initialized' = 1, 'Frozen' = 2)"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS state Enum8('Uninitialized' = 0, 'Initialized' = 1, 'Frozen' = 2)"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN state Enum8('Uninitialized' = 0, 'Initialized' = 1, 'Frozen' = 2)"),
            },
            ClickHouseColumnDefinition {
                name: "is_native".to_string(),
                clickhouse_type: r#"Nullable(UInt64)"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS is_native Nullable(UInt64)"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN is_native Nullable(UInt64)"),
            },
            ClickHouseColumnDefinition {
                name: "delegated_amount".to_string(),
                clickhouse_type: r#"UInt64"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS delegated_amount UInt64"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN delegated_amount UInt64"),
            },
            ClickHouseColumnDefinition {
                name: "close_authority".to_string(),
                clickhouse_type: r#"Nullable(String)"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS close_authority Nullable(String)"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN close_authority Nullable(String)"),
            },
        ]
    }
