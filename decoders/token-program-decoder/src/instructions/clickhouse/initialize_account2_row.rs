...
pub struct InitializeAccount2InstructionClickHouseRow {
...
impl InitializeAccount2InstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_initialize_account2_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "initialize_account2";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "token_program_initialize_account2_instruction_landing";
...
impl ClickHouseTable for InitializeAccount2InstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for InitializeAccount2InstructionClickHouseRow {
