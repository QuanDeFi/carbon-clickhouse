...
pub struct FreezeAccountInstructionClickHouseRow {
...
impl FreezeAccountInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_freeze_account_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "freeze_account";
    pub const DEFAULT_TABLE_NAME: &'static str = "token_program_freeze_account_instruction_landing";

    pub fn from_parts(
        source: crate::instructions::freeze_account::FreezeAccount,
...
impl ClickHouseTable for FreezeAccountInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for FreezeAccountInstructionClickHouseRow {
