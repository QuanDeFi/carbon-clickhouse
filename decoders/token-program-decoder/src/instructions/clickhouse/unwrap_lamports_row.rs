...
impl UnwrapLamportsInstructionClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS amount Nullable(UInt64)"),
        ]
    }
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                ...
                clickhouse_type: r#"Nullable(UInt64)"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS amount Nullable(UInt64)"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN amount Nullable(UInt64)"),
            },
        ]
    }
