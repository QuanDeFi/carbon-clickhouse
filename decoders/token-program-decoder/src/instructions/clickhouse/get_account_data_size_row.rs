...
pub struct GetAccountDataSizeInstructionClickHouseRow {
...
impl GetAccountDataSizeInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_get_account_data_size_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "get_account_data_size";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "token_program_get_account_data_size_instruction_landing";

    pub fn from_parts(
        source: crate::instructions::get_account_data_size::GetAccountDataSize,
...
impl ClickHouseTable for GetAccountDataSizeInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for GetAccountDataSizeInstructionClickHouseRow {
