...
pub struct WithdrawExcessLamportsInstructionClickHouseRow {
...
impl WithdrawExcessLamportsInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_withdraw_excess_lamports_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "withdraw_excess_lamports";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "token_program_withdraw_excess_lamports_instruction_landing";

    pub fn from_parts(
        source: crate::instructions::withdraw_excess_lamports::WithdrawExcessLamports,
...
impl ClickHouseTable for WithdrawExcessLamportsInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for WithdrawExcessLamportsInstructionClickHouseRow {
