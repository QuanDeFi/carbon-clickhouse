...
pub struct InitializeMultisig2InstructionClickHouseRow {
...
impl InitializeMultisig2InstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_initialize_multisig2_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "initialize_multisig2";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "token_program_initialize_multisig2_instruction_landing";
...
impl ClickHouseTable for InitializeMultisig2InstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for InitializeMultisig2InstructionClickHouseRow {
