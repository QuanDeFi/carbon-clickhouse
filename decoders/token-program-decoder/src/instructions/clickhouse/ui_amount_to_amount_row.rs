...
impl ClickHouseTable for UiAmountToAmountInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl UiAmountToAmountInstructionClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS ui_amount String"),
        ]
    }
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                name: "ui_amount".to_string(),
                clickhouse_type: r#"String"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS ui_amount String"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN ui_amount String"),
            },
        ]
    }
...
impl ClickHouseRow for UiAmountToAmountInstructionClickHouseRow {
