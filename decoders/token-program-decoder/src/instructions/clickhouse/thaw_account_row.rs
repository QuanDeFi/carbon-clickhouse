...
pub struct ThawAccountInstructionClickHouseRow {
...
impl ThawAccountInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_thaw_account_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "thaw_account";
    pub const DEFAULT_TABLE_NAME: &'static str = "token_program_thaw_account_instruction_landing";

    pub fn from_parts(
        source: crate::instructions::thaw_account::ThawAccount,
...
impl ClickHouseTable for ThawAccountInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for ThawAccountInstructionClickHouseRow {
