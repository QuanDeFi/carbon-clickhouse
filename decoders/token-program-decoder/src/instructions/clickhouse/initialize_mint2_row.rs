...
pub struct InitializeMint2InstructionClickHouseRow {
...
impl InitializeMint2InstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_initialize_mint2_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "initialize_mint2";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "token_program_initialize_mint2_instruction_landing";
...
impl ClickHouseTable for InitializeMint2InstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for InitializeMint2InstructionClickHouseRow {
