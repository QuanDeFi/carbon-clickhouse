...
pub struct InitializeAccountInstructionClickHouseRow {
...
impl InitializeAccountInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_initialize_account_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "initialize_account";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "token_program_initialize_account_instruction_landing";

    pub fn from_parts(
        source: crate::instructions::initialize_account::InitializeAccount,
...
impl ClickHouseTable for InitializeAccountInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for InitializeAccountInstructionClickHouseRow {
