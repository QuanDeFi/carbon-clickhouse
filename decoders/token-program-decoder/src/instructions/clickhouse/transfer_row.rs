...
pub struct TransferInstructionClickHouseRow {
...
impl TransferInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_transfer_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "transfer";
    pub const DEFAULT_TABLE_NAME: &'static str = "token_program_transfer_instruction_landing";
...
impl ClickHouseTable for TransferInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for TransferInstructionClickHouseRow {
