...
impl BatchInstructionClickHouseRow {
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                name: "data".to_string(),
                clickhouse_type: r#"Array(Tuple(number_of_accounts UInt8, instruction_data Array(UInt8)))"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS data Array(Tuple(number_of_accounts UInt8, instruction_data Array(UInt8)))"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN data Array(Tuple(number_of_accounts UInt8, instruction_data Array(UInt8)))"),
            },
        ]
    }
