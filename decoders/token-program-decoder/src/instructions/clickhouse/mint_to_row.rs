...
pub struct MintToInstructionClickHouseRow {
...
impl MintToInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_mint_to_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "mint_to";
    pub const DEFAULT_TABLE_NAME: &'static str = "token_program_mint_to_instruction_landing";
...
impl ClickHouseTable for MintToInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for MintToInstructionClickHouseRow {
