...
pub struct ApproveInstructionClickHouseRow {
...
impl ApproveInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_approve_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "approve";
    pub const DEFAULT_TABLE_NAME: &'static str = "token_program_approve_instruction_landing";
