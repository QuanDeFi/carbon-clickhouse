...
pub struct MintToCheckedInstructionClickHouseRow {
...
impl MintToCheckedInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "token_program_mint_to_checked_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "mint_to_checked";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "token_program_mint_to_checked_instruction_landing";
...
impl ClickHouseTable for MintToCheckedInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for MintToCheckedInstructionClickHouseRow {
