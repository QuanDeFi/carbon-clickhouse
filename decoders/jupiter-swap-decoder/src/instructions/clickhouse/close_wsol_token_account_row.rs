...
pub struct CloseWsolTokenAccountInstructionClickHouseRow {
...
impl CloseWsolTokenAccountInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "jupiter_swap_close_wsol_token_account_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "close_wsol_token_account";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "jupiter_swap_close_wsol_token_account_instruction_landing";

    pub fn from_parts(
        source: crate::instructions::close_wsol_token_account::CloseWsolTokenAccount,
...
impl ClickHouseTable for CloseWsolTokenAccountInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for CloseWsolTokenAccountInstructionClickHouseRow {
