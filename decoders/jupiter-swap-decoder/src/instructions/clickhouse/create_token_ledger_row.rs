...
pub struct CreateTokenLedgerInstructionClickHouseRow {
...
impl CreateTokenLedgerInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "jupiter_swap_create_token_ledger_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "create_token_ledger";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "jupiter_swap_create_token_ledger_instruction_landing";

    pub fn from_parts(
        source: crate::instructions::create_token_ledger::CreateTokenLedger,
...
impl ClickHouseTable for CreateTokenLedgerInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for CreateTokenLedgerInstructionClickHouseRow {
