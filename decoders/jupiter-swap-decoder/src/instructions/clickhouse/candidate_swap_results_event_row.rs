...
impl ClickHouseTable for CandidateSwapResultsEventClickHouseRow {
    fn table() -> &'static str {
...
impl CandidateSwapResultsEventClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS results Array(Tuple(variant Enum8('OutAmount' = 0, 'ProgramError' = 1), value_0 Nullable(UInt64)))"),
        ]
    }
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                ...
                clickhouse_type: r#"Array(Tuple(variant Enum8('OutAmount' = 0, 'ProgramError' = 1), value_0 Nullable(UInt64)))"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS results Array(Tuple(variant Enum8('OutAmount' = 0, 'ProgramError' = 1), value_0 Nullable(UInt64)))"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN results Array(Tuple(variant Enum8('OutAmount' = 0, 'ProgramError' = 1), value_0 Nullable(UInt64)))"),
            },
        ]
    }
    ...
    fn create_table_sql_for(
        ...
        format!(
            ...
            results Array(Tuple(variant Enum8('OutAmount' = 0, 'ProgramError' = 1), value_0 Nullable(UInt64)))\
        ) ENGINE = {engine}{merge_tree_clauses}"
        )
    }
}

impl ClickHouseRow for CandidateSwapResultsEventClickHouseRow {
