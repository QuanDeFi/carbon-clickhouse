...
impl ClickHouseTable for CloseTokenInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl CloseTokenInstructionClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS burn_all Bool"),
        ]
    }
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                name: "burn_all".to_string(),
                clickhouse_type: r#"Bool"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS burn_all Bool"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN burn_all Bool"),
            },
        ]
    }
...
impl ClickHouseRow for CloseTokenInstructionClickHouseRow {
