...
impl ClickHouseTable for CreateTokenAccountInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl CreateTokenAccountInstructionClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS bump UInt8"),
        ]
    }
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                ...
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS bump UInt8"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN bump UInt8"),
            },
        ]
    }
...
impl ClickHouseRow for CreateTokenAccountInstructionClickHouseRow {
