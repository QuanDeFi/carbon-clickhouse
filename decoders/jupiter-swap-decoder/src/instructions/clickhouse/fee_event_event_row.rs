...
impl ClickHouseTable for FeeEventEventClickHouseRow {
    fn table() -> &'static str {
...
impl FeeEventEventClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS account String"),
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                ...
                clickhouse_type: r#"String"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS account String"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN account String"),
            },
            ClickHouseColumnDefinition {
                name: "mint".to_string(),
                clickhouse_type: r#"String"#.to_string(),
...
impl ClickHouseRow for FeeEventEventClickHouseRow {
