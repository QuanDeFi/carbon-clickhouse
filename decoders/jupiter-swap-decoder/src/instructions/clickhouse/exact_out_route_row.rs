...
#[derive(Debug, Clone, serde::Serialize)]
pub struct ExactOutRouteInstructionClickHouseRow {
...
impl ExactOutRouteInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "jupiter_swap_exact_out_route_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "exact_out_route";
    pub const DEFAULT_TABLE_NAME: &'static str = "jupiter_swap_exact_out_route_instruction_landing";
...
impl ClickHouseTable for ExactOutRouteInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for ExactOutRouteInstructionClickHouseRow {
