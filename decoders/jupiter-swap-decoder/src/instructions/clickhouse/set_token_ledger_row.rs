...
pub struct SetTokenLedgerInstructionClickHouseRow {
...
impl SetTokenLedgerInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "jupiter_swap_set_token_ledger_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "set_token_ledger";
    pub const DEFAULT_TABLE_NAME: &'static str =
        "jupiter_swap_set_token_ledger_instruction_landing";

    pub fn from_parts(
        source: crate::instructions::set_token_ledger::SetTokenLedger,
...
impl ClickHouseTable for SetTokenLedgerInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for SetTokenLedgerInstructionClickHouseRow {
