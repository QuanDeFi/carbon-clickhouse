...
impl ClickHouseTable for SharedAccountsExactOutRouteInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl SharedAccountsExactOutRouteInstructionClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS quoted_in_amount UInt64"),
...
impl ClickHouseRow for SharedAccountsExactOutRouteInstructionClickHouseRow {
