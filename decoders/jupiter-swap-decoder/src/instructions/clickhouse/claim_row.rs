...
pub struct ClaimInstructionClickHouseRow {
...
impl ClaimInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "jupiter_swap_claim_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "claim";
    pub const DEFAULT_TABLE_NAME: &'static str = "jupiter_swap_claim_instruction_landing";
...
impl ClickHouseTable for ClaimInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for ClaimInstructionClickHouseRow {
