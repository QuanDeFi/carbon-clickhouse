...
impl ClickHouseTable for CandidateSwapQuoteErrorEventClickHouseRow {
    fn table() -> &'static str {
...
impl CandidateSwapQuoteErrorEventClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS candidate_index UInt64"),
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS in_amount UInt64"),
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS error_code UInt64"),
        ]
    }
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                ...
                clickhouse_type: r#"UInt64"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS candidate_index UInt64"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN candidate_index UInt64"),
            },
            ClickHouseColumnDefinition {
            ...
            ClickHouseColumnDefinition {
                ...
                clickhouse_type: r#"UInt64"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS error_code UInt64"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN error_code UInt64"),
            },
        ]
    }
...
impl ClickHouseRow for CandidateSwapQuoteErrorEventClickHouseRow {
