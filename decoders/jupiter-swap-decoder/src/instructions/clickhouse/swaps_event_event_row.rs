...
impl SwapsEventEventClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS swap_events Array(Tuple(input_mint String, input_amount UInt64, output_mint String, output_amount UInt64))"),
        ]
    }
    ...
    pub fn column_definitions(table_name: &str) -> Vec<ClickHouseColumnDefinition> {
        vec![
            ...
            ClickHouseColumnDefinition {
                name: "swap_events".to_string(),
                clickhouse_type: r#"Array(Tuple(input_mint String, input_amount UInt64, output_mint String, output_amount UInt64))"#.to_string(),
                add_column_sql: format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS swap_events Array(Tuple(input_mint String, input_amount UInt64, output_mint String, output_amount UInt64))"),
                modify_column_sql: format!("ALTER TABLE {table_name} MODIFY COLUMN swap_events Array(Tuple(input_mint String, input_amount UInt64, output_mint String, output_amount UInt64))"),
            },
        ]
    }
    ...
    fn create_table_sql_for(
        ...
        format!(
            ...
            swap_events Array(Tuple(input_mint String, input_amount UInt64, output_mint String, output_amount UInt64))\
