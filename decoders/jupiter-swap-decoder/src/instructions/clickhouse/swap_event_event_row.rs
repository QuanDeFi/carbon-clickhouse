...
impl SwapEventEventClickHouseRow {
    ...
    pub fn add_column_sql(table_name: &str) -> Vec<String> {
        vec![
            ...
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS amm String"),
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS input_mint String"),
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS input_amount UInt64"),
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS output_mint String"),
            format!("ALTER TABLE {table_name} ADD COLUMN IF NOT EXISTS output_amount UInt64"),
        ]
    }
