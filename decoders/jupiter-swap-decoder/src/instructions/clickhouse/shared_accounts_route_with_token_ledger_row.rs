...
#[derive(Debug, Clone, serde::Serialize)]
pub struct SharedAccountsRouteWithTokenLedgerInstructionClickHouseRow {
...
impl SharedAccountsRouteWithTokenLedgerInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str =
        "jupiter_swap_shared_accounts_route_with_token_ledger_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "shared_accounts_route_with_token_ledger";
...
impl ClickHouseTable for SharedAccountsRouteWithTokenLedgerInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for SharedAccountsRouteWithTokenLedgerInstructionClickHouseRow {
