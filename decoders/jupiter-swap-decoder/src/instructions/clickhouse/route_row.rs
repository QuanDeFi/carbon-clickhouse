...
#[derive(Debug, Clone, serde::Serialize)]
pub struct RouteInstructionClickHouseRow {
...
impl RouteInstructionClickHouseRow {
    pub const FAMILY_NAME: &'static str = "jupiter_swap_route_instruction";
    pub const INSTRUCTION_TYPE: &'static str = "route";
    pub const DEFAULT_TABLE_NAME: &'static str = "jupiter_swap_route_instruction_landing";
...
impl ClickHouseTable for RouteInstructionClickHouseRow {
    fn table() -> &'static str {
...
impl ClickHouseRow for RouteInstructionClickHouseRow {
